/*
*FileName: FriedMiraak.cs
*Author : Zane Myers
*Description : Class for defining the properties of and creating the object FriedMiraak
*/
...
namespace BleakwindBuffet.Data.Sides
{
    ...
    public class FriedMiraak : Side, INotifyPropertyChanged
    {
        ...
        {
            return $"{Size} Fried Miraak";// set return value of ToString to {sideSize} Fried Miraak
        }
    }
}
